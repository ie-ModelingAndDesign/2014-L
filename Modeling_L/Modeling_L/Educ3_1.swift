...
class Educ3_1: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "Educ3_1.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "共通教育棟3号館 1階", style:.Bordered, target: self, action: nil)
    ...
    */
    func onClickBarButton(sender: UIBarButtonItem) {
        ...
        if sender.tag == 2 {
            println("floor2")
            var nextViewController: UIViewController = Educ3_2()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 3 {
            println("floor3")
            var nextViewController: UIViewController = Educ3_3()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 4 {
            println("floor4")
            var nextViewController: UIViewController = Educ3_4()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 5 {
            println("floor5")
            var nextViewController: UIViewController = Educ3_5()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        }
