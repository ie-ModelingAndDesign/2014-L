...
class LN1: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "new1.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "法文新棟 1階", style:.Bordered, target: self, action: nil)
    ...
    */
    func onClickBarButton(sender: UIBarButtonItem) {
        ...
        if sender.tag == 2 {
            println("floor2")
            var nextViewController: UIViewController = LN2()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        }
        else if sender.tag == 3 {
            println("floor3")
            var nextViewController: UIViewController = LN3()
            self.presentViewController(nextViewController, animated: false, completion: nil)
