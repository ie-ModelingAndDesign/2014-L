...
class Educ4_1: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "Educ4_1.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "共通教育棟4号館 1階", style:.Bordered, target: self, action: nil)
    ...
    */
    func onClickBarButton(sender: UIBarButtonItem) {
        ...
        if sender.tag == 1 {
            ...
            println("floor2")
            // 遷移するViewを設定
            var nextViewController: UIViewController = Educ4_2()
            // Viewの移動
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 3 {
            println("floor3")
            var nextViewController: UIViewController = Educ4_3()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 4 {
            println("floor4")
            var nextViewController: UIViewController = Educ4_4()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        } else if sender.tag == 5 {
            println("floor5")
            var nextViewController: UIViewController = Educ4_5()
            self.presentViewController(nextViewController, animated: false, completion: nil)
        }
