...
class Educ4_2: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "Educ4_2.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "共通教育棟4号館 2階", style:.Bordered, target: self, action: nil)
