...
class Educ3_5: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "Educ3_5.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "共通教育棟3号館 5階", style:.Bordered, target: self, action: nil)
