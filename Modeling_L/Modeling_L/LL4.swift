...
class LL4: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        let myImage = UIImage(named: "law4.png")
        ...
        */
        ...
        // マップ名称ボタンを生成する.
        let myNameButton: UIBarButtonItem = UIBarButtonItem(title: "法文棟 4階", style:.Bordered, target: self, action: nil)
    ...
    */
    func onClickBarButton(sender: UIBarButtonItem) {
        ...
        if sender.tag == 1 {
            ...
            println("floor6")
            var nextViewController: UIViewController = LL6()
            self.presentViewController(nextViewController, animated: false, completion: nil)
    ...
    */
    ...
    func makeLLWindow(){
        ...
        LLB3.setTitleColor(UIColor.whiteColor(), forState: .Normal)
