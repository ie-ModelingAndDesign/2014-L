...
class Educ2: UIViewController, UIToolbarDelegate, UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        // UIImageに画像を設定する.
        let myImage = UIImage(named: "test2.jpg")
    ...
    */
    func onClickBarButton(sender: UIBarButtonItem) {
        if sender.tag == 1 {
            // 遷移するViewを設定
            let nextViewController: UIViewController = Educ1()
            // Viewの移動
            self.navigationController?.pushViewController(Educ1(), animated: false)
